<html>
  ...
  <head>
    <title> Farmer Signup | Farm Culture </title>
  </head>

  <link rel="stylesheet" type = "text/css" href ="css/farmersignup.css">
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Farmer, <br> Welcome to <span class="edit"> Farm Culture </span></h1>
     <br>
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="farmer_registered_success.php" method="POST">
       ...
       <label style="margin-left: 5px;"><a href="farmerlogin.php">Have an account? Login.</a></label>
  ...
  <br>
  <p> veggy Exploria 2017 | &copy All Rights Reserved </p>
  <br>
  </footer>
</html>