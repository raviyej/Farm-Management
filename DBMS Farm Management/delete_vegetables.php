...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="delete_vegetables1.php" method="POST">
        <br style="clear: both">
...
$sql = "SELECT * FROM vegetables v WHERE v.options = 'ENABLE' AND v.F_ID IN (SELECT r.R_ID FROM farms f WHERE f.M_ID='$user_check') ORDER BY V_ID";
