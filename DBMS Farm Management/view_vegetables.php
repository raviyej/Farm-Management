...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/view_vegetables.css">
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="view_vegetables.php" class="list-group-item active">View Vegetable</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> YOUR VEGETABLE ITEMS LIST </h3>
...
$sql = "SELECT * FROM vegetables v WHERE v.F_ID IN (SELECT f.F_ID FROM FARM f WHERE f.M_ID='$user_check') ORDER BY V_ID";
