...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> YOUR VEGETABLE ORDER LIST </h3>
...
$sql = "SELECT * FROM orders o WHERE o.F_ID IN (SELECT f.V_ID FROM FARMS f WHERE f.M_ID='$user_check') ORDER BY order_date";
