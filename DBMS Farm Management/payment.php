...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $V_ID = $values["vegetable_id"];
    $vegetablename = $values["vegetable_name"];
    $quantity = $values["vegetable_quantity"];
    $price =  $values["vegetable_price"];
    $total = ($values["vegetable_quantity"] * $values["vegetable_price"]);
    $F_ID = $values["F_ID"];
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (vegetable_id, vegetable_name, price,  quantity, order_date, username, F_ID) 
              VALUES ('" . $V_ID . "','" . $vegetablename . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $F_ID . "')";
